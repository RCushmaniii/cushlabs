...
| **Premium** ⭐ most popular       | **$3,490** | **$229** | Everything in Basic **+** website chatbot **+** weekly local SEO & competitor report                     |
...
> The AI lives on **Facebook** (Messenger + comments). The **owner is alerted on WhatsApp** when a lead is hot.
> "We alert you on WhatsApp" ≠ "the AI runs on WhatsApp." The first is LIVE and core. The second is HELD and unsellable.
...
- **Answered in under 5 seconds, 24/7** — you stop losing leads to slow replies and keep Facebook's "responds quickly" badge.
...
- **Grounded, never invents** — hard facts (hours/prices) come back exact; when unsure it offers a human.
...
CushLabs sells one managed subscription in three tiers (Basic $1,990 MXN / Premium $3,490 / Ultra $5,490, per business, 2 locations, no contract, 2-week trial). The core is a **bilingual AI on the client's Facebook** (Messenger + comments), trained to sound like them, that captures leads and **alerts the owner on WhatsApp**. Basic also includes Google review management; Premium adds a website chatbot + weekly SEO/competitor report; Ultra adds a voice agent. We do **not** do AI-on-WhatsApp, build/run Facebook pages, or build websites. The truth about all of this is in `docs/strategy/ADVERTISED-COMMITMENTS.md` — read it before you propose or price anything.
