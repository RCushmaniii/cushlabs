...
const details: Record<string, ProjectDetailOverride> = {
  "cushlabs": {
    ...
    thumbnail: "/images/portfolio/cushlabs-01.webp",
    videoUrl: "/images/portfolio/cushlabs-brief.mp4",
    videoPoster: "/images/portfolio/cushlabs-video-poster.jpg",
    images: [
      { src: "/images/portfolio/cushlabs-01.webp", alt: { en: "CushLabs AI Services — The Self-Maintaining Bilingual Portfolio", es: "CushLabs AI Services — El Portafolio Bilingue Auto-Mantenido" } },
      { src: "/images/portfolio/cushlabs-02.webp", alt: { en: "Not Just a Website, But a System — bilingual, automated sync, serverless booking", es: "No Solo un Sitio Web, Sino un Sistema — bilingue, sincronizacion automatizada, reservas serverless" } },
      { src: "/images/portfolio/cushlabs-03.webp", alt: { en: "Premium Design is About Behavior — zero-flash theming, time-based dark mode, micro-interactions", es: "El Diseno Premium es Sobre Comportamiento — temas sin flash, modo oscuro basado en hora, micro-interacciones" } },
      { src: "/images/portfolio/cushlabs-04.webp", alt: { en: "Engineering Visibility — the enterprise SEO stack with JSON-LD, hreflang, and lazy loading", es: "Visibilidad de Ingenieria — el stack SEO empresarial con JSON-LD, hreflang y carga lazy" } },
      { src: "/images/portfolio/cushlabs-05.webp", alt: { en: "True Bilingual Architecture — 24-line custom TypeScript i18n vs 40KB+ i18next", es: "Arquitectura Bilingue Real — i18n TypeScript personalizado de 24 lineas vs i18next de 40KB+" } },
      ...
      { src: "/images/portfolio/cushlabs-07.webp", alt: { en: "Localization Beyond Language — WhatsApp integration with locale-aware pre-filled messages", es: "Localizacion Mas Alla del Idioma — integracion WhatsApp con mensajes prellenados segun el idioma" } },
      { src: "/images/portfolio/cushlabs-08.webp", alt: { en: "Security and Anti-Scraping — split-attribute email obfuscation", es: "Seguridad y Anti-Scraping — ofuscacion de email por atributos divididos" } },
    ],
    en: {
