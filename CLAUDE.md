...
2. Astro 4→6 + Tailwind 3→4 migration (major framework upgrade, requires dedicated effort)
...
- ~~Dependabot vulnerabilities~~ — yaml CVE fixed via override, Astro/esbuild CVEs dismissed (static site, SSR-only), vitest vite CVE fixed via update
